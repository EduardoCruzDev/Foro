...
import com.eduardocruzdev.foro.configuration.Templates;
import com.eduardocruzdev.foro.domain.dto.SectionDTO;
import com.eduardocruzdev.foro.domain.dto.SectionForm;
import com.eduardocruzdev.foro.domain.model.Section;
import com.eduardocruzdev.foro.domain.utiles.FileService;
import com.eduardocruzdev.foro.domain.utiles.FileUtils;
import com.eduardocruzdev.foro.domain.utiles.ForoModelMap;
...
public class SectionAdminController {
    ...
    private final ForoModelMap modelMapper;

    public SectionAdminController(SectionService sectionService, FileService fileService, ForoModelMap modelMapper) {
    ...
    public String getSectionForm(Model model, @PathVariable int id) {
        ...
        model.addAttribute("newSection",
                SectionForm.builder()
                        .id(Math.toIntExact(section.getId()))
